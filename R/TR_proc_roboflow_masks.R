...
#' Get Roboflow ROI masks/annotations as polygons and raster objects
#'
...
#' Simplify and aggregate ROI masks by label from Roboflow annotations
#'
...
#'
#' @param masks A list generated by `get_roboflow_masks` containing the labels/categories (`labs`),
...
#
# extract_values_roi_masks <- function(roi, pols = NULL, labs_field = NULL,
#                                      labs = NULL, rst){
#
#   if(!inherits(roi,"TR.ROI")){
#     stop("roi must be an object of class TR.ROI generated by get_roboflow_masks
#          or simplify_roboflow_masks!")
#   }
#
...
#
#   if(!is.null(pols)){
#     if(is.null(labs_field) && is.null(labs)){
#       stop("Polygon ROIs labels must be identified by either a field in the
#       attribute table (labs_field) OR by a character vector in labs!")
#     }
#   }
#
#
