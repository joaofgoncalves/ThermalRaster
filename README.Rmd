...
ℹ️ [**Note**]{.underline}: polygons cannot have “holes” or “islands”. This set of tools for annotation in Roboflow app cannot handle such representations.
...
ℹ️ [**Note**]{.underline}: Re-scaling annotations is not needed if the size of the RGB and thermal images is exactly the same (which happens for "cropped" images as shown in the examples before).
